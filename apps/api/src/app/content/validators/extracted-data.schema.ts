...
export const BeerReleaseSchema = z.object({
  ...
  releaseDate: z
    .string()
    .optional()
    .describe('When the beer is being released (ISO date or natural language)'),
  availability: z
    .enum(['draft', 'cans', 'bottles', 'limited', 'ongoing'])
    .optional()
    .describe('How the beer is available'),
  price: z.string().optional().describe('Price information if mentioned'),
  collaboration: z
    .string()
    .optional()
    .describe('Collaboration partner (brewery, artist, brand, etc.)'),
});
...
export const EventSchema = z.object({
  ...
  date: z
    .string()
    .describe('Event date (ISO date or natural language like "this Saturday")'),
  time: z.string().optional().describe('Event time'),
  location: z
    .string()
    .optional()
    .describe('Event location (taproom, specific address, etc.)'),
...
export const UpdateSchema = z.object({
  ...
  urls: z
    .array(z.string())
    .optional()
    .describe('Any URLs mentioned in the update'),
});
...
export const ExtractedContentSchema = z.object({
  contentType: z
    ...
    .describe('Primary type of this content'),
  ...
  beerReleases: z
    .array(BeerReleaseSchema)
    .optional()
    .describe('List of beer releases mentioned'),
  ...
  summary: z
    .string()
    .describe('Brief summary of the entire content (2-3 sentences)'),
  ...
  callToAction: z
    ...
    .optional()
    .describe(
      'Main call to action if present (visit taproom, order online, etc.)'
    ),
});
