...
export class AppService {
  ...
  /*constructor() {
    const getDataFlow = defineFlow(
      ...
      async (subject: string) => {
        ...
        const data = {
          breweryName: this.extractBreweryName(response),
          events: this.extractEvents(response),
          newReleases: this.extractNewReleases(response),
          tastingNotes: this.extractTastingNotes(response),
          contactInfo: this.extractContactInfo(response),
        };
        return data;
      }
    );
  ...
  async getData(subject: string): Promise<any> {
    console.log(this.getDataFlow);
    return this.getDataFlow(subject);
  }*/
